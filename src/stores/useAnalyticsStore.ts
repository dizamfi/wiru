...
//   // Filters
//   currentPeriod: getDefaultDateRange(),
//   selectedMetrics: ['earnings', 'orders', 'environmental'],
//   chartType: 'line',
...
//               Date.now() - new Date(get().lastFetch!).getTime() < 5 * 60 * 1000) { // 5 min cache
//             set({ 
//               dashboard: cached,
...
//           const advanced = await analyticsApi.getAdvancedAnalytics();
          
//           set({ advanced, loading: false });
//         } catch (error) {
//           set({
//             error: error instanceof Error ? error.message : 'Error al cargar analytics avanzados',
//             loading: false
//           });
//         }
//       },
...
//       setPresetPeriod: (preset: AnalyticsPeriod['value']) => {
//         const today = new Date();
//         let from: Date;
//         let to: Date = today;
